    ...
    <div style={{
      ...
      <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
        ...
        <div style={{ flexGrow: 1, minWidth: 0 }}>
          ...
          {/* Select Menu Component V2 Dropdown Preview */}
          {selectMenuEnabled && (
            <div style={{ marginTop: '10px', width: '100%', maxWidth: '420px' }}>
              <div style={{
                backgroundColor: '#2b2d31',
                ...
                <span style={{ color: '#dbdee1', fontWeight: '500', display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
                  <span>{selectMenuPlaceholder || 'Select an option...'}</span>
                </span>
              ...
              {/* Expanded options representation */}
