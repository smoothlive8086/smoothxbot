            ...
            <form onSubmit={handleSave} onKeyDown={handleFormKeyDown}>
              ...
              {activeTab === 'fullmoderation' && settings && (
                <div>
                  ...
                  {settings.fullModeration?.enabled && (
                    <>
                      {/* Protection Action Rules */}
                      <div className="glass-panel" style={{ padding: '24px', marginBottom: '24px', backgroundColor: 'rgba(255,255,255,0.01)' }}>
                        <h3 style={{ fontSize: '1.2rem', fontWeight: '700', marginBottom: '6px' }}>Administrative Lockdown Controls</h3>
                        <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', marginBottom: '20px' }}>
                          Select which role modifications are forbidden for non-whitelisted administrators.
                        </p>

                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px' }}>
                          <div className="glass-panel" style={{ padding: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.1)' }}>
                            <div style={{ flex: 1, marginRight: '16px' }}>
                              <h4 style={{ fontSize: '1rem', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '8px' }}>
                                <ShieldAlert size={16} color="#ef4444" />
                                Prevent Role Creation
                              </h4>
                              <p style={{ fontSize: '0.75rem', color: 'var(--text-secondary)', marginTop: '4px' }}>
                                Non-whitelisted admins cannot create roles. If a role is created, the bot instantly deletes it.
                              </p>
                            </div>
                            <label className="switch">
                              <input
                                type="checkbox"
                                checked={settings.fullModeration?.preventRoleCreate !== false}
                                onChange={() => handleToggle('fullModeration.preventRoleCreate')}
                              />
                              <span className="slider"></span>
                            </label>
                          </div>
                          ...
                          <div className="glass-panel" style={{ padding: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.1)' }}>
                            <div style={{ flex: 1, marginRight: '16px' }}>
                              <h4 style={{ fontSize: '1rem', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '8px' }}>
                                ...
                                Prevent Role Assignment (Give Roles)
                              </h4>
                              <p style={{ fontSize: '0.75rem', color: 'var(--text-secondary)', marginTop: '4px' }}>
                                Non-whitelisted admins cannot give or assign any roles to members. If attempted, the bot immediately reverts and removes the role.
                              </p>
                            </div>
                            <label className="switch">
                              <input
                                type="checkbox"
                                checked={settings.fullModeration?.preventRoleGive !== false}
                                onChange={() => handleToggle('fullModeration.preventRoleGive')}
                              />
                              <span className="slider"></span>
                            </label>
                          </div>
                          ...
                          <div className="glass-panel" style={{ padding: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.1)' }}>
                            <div style={{ flex: 1, marginRight: '16px' }}>
                              ...
                              <p style={{ fontSize: '0.75rem', color: 'var(--text-secondary)', marginTop: '4px' }}>
                                Non-whitelisted admins cannot delete roles. If deleted, the bot immediately recreates the role.
                              </p>
                            </div>
                            <label className="switch">
                              <input
                                type="checkbox"
                                checked={settings.fullModeration?.preventRoleDelete !== false}
                                onChange={() => handleToggle('fullModeration.preventRoleDelete')}
                              />
                              <span className="slider"></span>
                            </label>
                          </div>
                      ...
                      <div className="glass-panel" style={{ padding: '24px', marginBottom: '24px', backgroundColor: 'rgba(255,255,255,0.01)', overflow: 'visible' }}>
                        <h3 style={{ fontSize: '1.2rem', fontWeight: '700', marginBottom: '6px' }}>Full Moderation Whitelist</h3>
                        <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', marginBottom: '16px' }}>
                          Only administrators in this whitelist (or with a whitelisted role) are authorized to create or give roles.
                        </p>
                        ...
                        <div style={{
                          ...
                          <span>
                            <strong>Default Immunity:</strong> The Server Owner (<code style={{ color: '#fff' }}>Crown</code>) and the Bot itself are permanently whitelisted and immune to restrictions.
                          </span>
                        </div>
                        ...
                        <div style={{ position: 'relative', zIndex: 10, marginBottom: '24px' }}>
                          <label style={{ display: 'block', fontSize: '0.85rem', color: 'var(--text-secondary)', marginBottom: '6px' }}>
                            Search and Add Administrator to Whitelist
                          </label>
                        ...
                        <div style={{ marginTop: '20px' }}>
                          <h4 style={{ fontSize: '0.95rem', fontWeight: '600', marginBottom: '12px' }}>
                            Whitelisted Administrators ({settings.fullModeration?.whitelistedUsers?.length || 0})
                          </h4>
                          ...
                          {(!settings.fullModeration?.whitelistedUsers || settings.fullModeration.whitelistedUsers.length === 0) ? (
                            <div style={{ padding: '24px', textAlign: 'center', background: 'rgba(0,0,0,0.1)', borderRadius: '8px', color: 'var(--text-muted)', fontSize: '0.85rem' }}>
                              No additional administrators whitelisted yet. All admins (except Server Owner) will be strictly prevented from creating or giving roles.
                            </div>
                          ) : (
                        ...
                        {/* Whitelisted Roles Section */}
                        <div style={{ marginTop: '24px', borderTop: '1px solid var(--border-color)', paddingTop: '20px' }}>
                          <h4 style={{ fontSize: '0.95rem', fontWeight: '600', marginBottom: '6px' }}>
                            Whitelisted Roles (Optional)
                          </h4>
                          <p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', marginBottom: '12px' }}>
                            Members possessing any of these checked roles will also bypass Full Moderation restrictions.
                          </p>
