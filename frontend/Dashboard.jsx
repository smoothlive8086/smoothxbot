...
export default function Dashboard({ guildId, guildName, guildIcon, memberCount, onBack, user, onLogout }) {
  ...
  const renderCanvasCard = () => {
    ...
    return (
      <div className="glass-panel" style={{
        ...
        ) : 'linear-gradient(135deg, #000000 0%, #0a0a0a 50%, #040914 100%)',
  ...
  const getLogActionInfo = (type) => {
    ...
    switch (action) {
      ...
      case 'voice_move':
        return { label: 'MOVED VC', color: '#38bdf8', bg: 'rgba(56, 189, 248, 0.12)', icon: '🔀' };
      case 'voice_mute':
                  ...
                  <div className="glass-panel" style={{ padding: '24px', marginTop: '24px', backgroundColor: 'rgba(255,255,255,0.01)', overflow: 'visible' }}>
                    ...
                    {settings?.moderation?.wordFilter?.enabled && (
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', borderTop: '1px solid var(--border-color)', paddingTop: '20px' }}>
                        ...
                        <div style={{ background: 'rgba(56, 189, 248, 0.05)', padding: '20px', borderRadius: '12px', border: '1px solid rgba(56, 189, 248, 0.2)' }}>
                              ...
                              <div style={{
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                                  ...
                                  {poll.settings?.multipleChoice && (
                                    <span style={{ fontSize: '0.65rem', padding: '1px 6px', borderRadius: '4px', background: 'rgba(56,189,248,0.15)', color: '#7dd3fc', border: '1px solid rgba(56,189,248,0.2)', fontWeight: '600' }}>
                                      Multi-Choice
                                    </span>
                                  )}
